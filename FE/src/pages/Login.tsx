                            ...
                            <div>
                                ...
                                <div className="mt-1 relative">
                                    <input
                                        ...
                                        required
                                        className="block w-full rounded-lg border-0 py-2.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-pink-500 sm:text-sm sm:leading-6 px-4 pr-10 transition-all duration-200"
                                        placeholder="••••••••"
